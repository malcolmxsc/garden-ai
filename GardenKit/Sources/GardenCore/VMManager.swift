...
public class VMManager: ObservableObject {
    ...
    public func boot(kernelPath: String, rootfsPath: String, memoryMB: UInt64 = 512, cpuCount: Int = 2) async throws {
        state = .booting
    ...
    public func addSharedDirectory(hostPath: String, mountTag: String, readOnly: Bool = false) -> VZVirtioFileSystemDeviceConfiguration {
