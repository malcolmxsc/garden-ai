...
│                                                  │
│  ┌──────────┐    ┌───────────────────────────┐   │
│  │ AI Agent │───→│ garden-agent (PID 1)      │   │
│  │ commands │    │  - gRPC server             │   │
│  └──────────┘    │  - eBPF probe loader (aya) │   │
...
│                                                    │
│  ┌─────────────────────────────────────────────┐  │
│  │  Telemetry Receiver (vSock 6001)            │  │
│  │  - Deserialize SecurityEvent stream         │  │
│  │  - Apply PolicyEngine rules                 │  │
│  │  - Log / Alert / Kill VM                    │  │
